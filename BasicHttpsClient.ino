...
void setup() {
  ...
  WiFi.mode(WIFI_STA);
  WiFiMulti.addAP("yamprasad_2.4", "yamsharma");
}
...
void loop() {
  ...
  if ((WiFiMulti.run() == WL_CONNECTED)) {
    ...
    if (https.begin(*client, "https://arjunpoudel122.com.np/insertdata.php")) {  // HTTPS

      Serial.print("[HTTPS] GET...\n");

      //postData = "temperature=" + String(temp_F) + "&heartrate=" + String(heartRate) + "&spo02level=" + String(spo2);
